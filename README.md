...
terrain and sparse editable voxel objects. The browser client pairs a Rust/WASM engine
with a React/TypeScript shell, much like Figma, and uses WebGPU for rendering. It runs
